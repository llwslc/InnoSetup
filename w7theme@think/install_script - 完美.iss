...
[Files]
Source: "{app}\卸载帮助.txt"; DestDir: "{app}"; Components: "Themes"; Flags: ignoreversion
Source: "{app}\目录说明.txt"; DestDir: "{pf}\w7theme@think"; Components: "Themes"; Flags: ignoreversion
Source: "{app}\w7theme@think.exe"; DestDir: "{app}"; Components: "Themes"; Flags: ignoreversion
...
[Icons]
Name: "{group}\w7theme@think"; Filename: "{app}\w7theme@think.exe"; WorkingDir: {app};
Name: "{group}\{cm:UninstallProgram,w7theme@think}"; Filename: "{uninstallexe}"; IconFilename: "{app}\001.ico"
Name: "{userdesktop}\w7theme@think"; Filename: "{app}\w7theme@think.exe"; WorkingDir: {app};
